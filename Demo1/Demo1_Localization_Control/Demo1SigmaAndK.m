...
filename = 'myData2(2.1).xlsx';
newDataDemo1 = xlsread(filename); 

%% Define motor parameters
K=0.21; % DC gain [rad/Vs]
sigma= 8.55; % time constant reciprocal [1/s]
%% Run a Simulation
%
...
legend('Simulated','Experimental','location','southeast')
xlabel('Time (s)')
ylabel('Velocity rad/s') % double check what this is angular or regular
